...
class SummaryWriter:
  ...
  def __init__(self, dir, write_graph=True):
    ...
    self.writer = tf.summary.FileWriter(
      dir, graph=tf.get_default_graph() if write_graph else None) #this creates an object that writes summary data into the disk
...
def discretized_gaussian_log_likelihood(x, *, means, log_scales): #This function is useful in machine learning for calculating the log-likelihood of data under a Gaussian distribution, which is a common task in many algorithms.
